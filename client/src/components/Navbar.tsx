...
import { toggleOpen } from "../store/toggleModalSlice";
        ...
        {!isLoggedIn ? (
          ...
          >
            ...
            <div className="relative">
              ...
              {openDropdown && (
                <div className="border border-slate-200 py-2 px-4 transition-all space-y-2 rounded-lg absolute bg-white -bottom-16 text-sm dark:bg-zinc-800 dark:text-white">
                  <ul>
                    <li>
                      <a href="#" className="">
                        Profile
